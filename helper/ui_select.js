 ...
 */
define('./hui.Select', ['./hui', './hui.Control'], function(){
...
hui.Select.prototype = {
    ...
    addOption: function(item){
        ...
        var elem = hui.dom.createElement('OPTION');
        elem.value = Object.prototype.toString.call(item) == '[object Object]' ? item[dataValue] : item;
        elem.text  = Object.prototype.toString.call(item) == '[object Object]' ? item[dataLabel] : item;
    ...
    getValue: function () {
        ...
        if (me.options) {
            for (var i=0,len=me.options.length; i<len; i++) {
                item = me.options[i];
                if (item && typeof item !== 'string' && item[dataValue] === selected ) {
